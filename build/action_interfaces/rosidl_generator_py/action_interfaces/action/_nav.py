    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'action_interfaces.action.Nav_Goal')
            logger.debug(
...
class Metaclass_Nav_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.Nav_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Nav_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.Nav_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Nav_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from action_interfaces.action import Nav
...
class Nav_SendGoal_Request(metaclass=Metaclass_Nav_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'action_interfaces/Nav_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'Nav_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_interfaces.action._nav import Nav_Goal
...
class Metaclass_Nav_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.Nav_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from action_interfaces.action import _nav
...
class Nav_SendGoal(metaclass=Metaclass_Nav_SendGoal):
    from action_interfaces.action._nav import Nav_SendGoal_Request as Request
    from action_interfaces.action._nav import Nav_SendGoal_Response as Response
...
class Nav_GetResult_Response(metaclass=Metaclass_Nav_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'action_interfaces/Nav_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'Nav_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_interfaces.action._nav import Nav_Result
...
class Metaclass_Nav_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.Nav_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Nav_GetResult(metaclass=Metaclass_Nav_GetResult):
    from action_interfaces.action._nav import Nav_GetResult_Request as Request
    from action_interfaces.action._nav import Nav_GetResult_Response as Response
...
class Metaclass_Nav_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.Nav_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Nav_FeedbackMessage(metaclass=Metaclass_Nav_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'action_interfaces/Nav_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'Nav_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from action_interfaces.action._nav import Nav_Feedback
...
class Nav(metaclass=Metaclass_Nav):
    ...
    from action_interfaces.action._nav import Nav_Goal as Goal
    # The result message defined in the action definition.
    from action_interfaces.action._nav import Nav_Result as Result
    # The feedback message defined in the action definition.
    from action_interfaces.action._nav import Nav_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from action_interfaces.action._nav import Nav_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from action_interfaces.action._nav import Nav_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from action_interfaces.action._nav import Nav_FeedbackMessage as FeedbackMessage
